...
namespace EventEspresso\RecurringEvents\src\domain\entities\admin\GraphQLData;
 ...
 * Description
 *
 * @package EventEspresso\RecurringEvents\src\domain\entities\admin\GraphQLData
 * @author  Manzoor Wani
 * @since   $VID:$
 */
