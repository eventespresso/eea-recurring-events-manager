 ...
 * Adds a modal window that appears when users click to add a new Event.
 * The modal window allows for the selection of an Event "Type"
 * that can then be used to modify/customize the Event Editor.
 *
